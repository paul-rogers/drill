...
public class RegexFormatPlugin extends EasyFormatPlugin<RegexFormatConfig> {
  ...
  @Override
  public int getReaderOperatorType() { return 0; }

  @Override
  public int getWriterOperatorType() { return 0; }
}
