...
public class AdHocTest extends DrillTest {
  ...
  public void testRegex() {
    String line = "2017-12-31 20:52:42,045 [main] ERROR o.apache.drill.exec.server.Drillbit - Failure during initial startup of Drillbit.";
    String regex = "(\\d\\d\\d\\d)-(\\d\\d)-(\\d\\d) (\\d\\d):(\\d\\d):(\\d\\d),\\d+ \\[([^]]*)] (\\w+) (\\S+) - (.*)";
