...
public class TestSumoPlugin extends ClusterTest {
  ...
  private static final String NITE_API_URL = "https://example.sumologic.net";
  private static final String ACCESS_ID = "<your id>";
  ...
  public static void setup() throws Exception {
    ...
    SumoStoragePluginConfig config =
        new SumoStoragePluginConfig(NITE_API_URL, ACCESS_ID, ACCESS_KEY,
  ...
  public void testSumoConfig() throws IOException {
    ObjectMapper mapper = new ObjectMapper();
    SumoStoragePluginConfig config = new SumoStoragePluginConfig(NITE_API_URL, "<my id>", "<my key>",
        "America/Los_Angeles", "-6m", "30s", false);
