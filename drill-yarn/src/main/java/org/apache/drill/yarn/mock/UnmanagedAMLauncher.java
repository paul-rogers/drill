 ...
 * <p>
 * This version shamelessly copied from org.apache.hadoop.yarn.applications.unmanagedamlauncher
 * and modified to allow greater timeout to give time to attach a debugger.
 */
public class UnmanagedAMLauncher {
  ...
  private static final long AM_STATE_WAIT_TIMEOUT_MS = 120_000;
  /**
   * @param args
