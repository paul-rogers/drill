...
public abstract class AbstractSchemaTracker implements ScanSchemaTracker {
  ...
  protected final MutableTupleMetadata schema = new MutableTupleMetadata();
  ...
  @Override
  public MutableTupleMetadata schema() { return schema; }
  ...
  public void resolveMissingCols(TupleMetadata missingCols) {
    new ScanSchemaResolver(schema, Mode.MISSING_COLS, false, errorContext)
