...
import org.apache.drill.exec.physical.impl.scan.v3.schema.ScanSchemaResolver.Mode;
...
public class ProjectionSchemaTracker extends AbstractSchemaTracker {
  ...
  public void applyProvidedSchema(TupleMetadata providedSchema) {
    ...
    new ScanSchemaResolver(schema,
        isStrict ? Mode.STRICT_PROVIDED_SCHEMA : Mode.LENIENT_PROVIDED_SCHEMA,
        true, errorContext)
  ...
  public void applyEarlyReaderSchema(TupleMetadata readerSchema) {
    new ScanSchemaResolver(schema, Mode.EARLY_READER_SCHEMA, true, errorContext)
  ...
  public void applyReaderSchema(TupleMetadata readerOutputSchema,
      CustomErrorContext errorContext) {
    new ScanSchemaResolver(schema, Mode.READER_SCHEMA, allowMapAdditions, errorContext)
