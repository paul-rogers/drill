...
//  private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(MSortTemplate.class);
  ...
  private CoreExecService context;
  ...
  @Override
  public void setup(final CoreExecService context, final BufferAllocator allocator, final SelectionVector4 vector4,
  ...
  public abstract void doSetup(@Named("context") CoreExecService context,
