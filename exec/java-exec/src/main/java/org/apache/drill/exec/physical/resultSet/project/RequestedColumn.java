...
public interface RequestedColumn {
   ...
   * and so on.
   * <p>
   * The projection type is, at best, a hint. Think of the type
   * not as a definitive statement "column x is an ARRAY', but
   * rather as a roll-up of evidence: "column x is consistent
   ...
   * the nth qualifier, up to the a map member. Examples:
   * {@code a, a[1], a['key'], a[0]['key'][1]}.
   *
   * @param posn position of the qualifier to check
   * @return the qualifier type, or null if no qualifier exists at
