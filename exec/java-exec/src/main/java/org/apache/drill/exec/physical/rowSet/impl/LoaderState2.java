...
public class LoaderState2 {
  ...
  public static class PrimitiveColumnState implements ColumnCoordinator {
    private enum State {
    ...
    public void allocateVector(ValueVector toAlloc) {
      ...
      AllocationHelper.allocate(toAlloc, resultSetLoader.initialRowCount(), schema().expectedWidth(), 10);
    }
