...
public class ModelVisitor<R, A> {
    ...
    protected R visitRow(HyperRowSetModel row, A arg) {
    ...
    protected R visitTuple(AbstractHyperTupleModel tuple, A arg) {
...
//    }
    ...
    protected R visitColumn(AbstractHyperColumnModel column, A arg) { return null; }
  }