...
/**
 * Represents a request to project all of a root-level row.
 * Handles special columns defined in metadata. A subclass
 * can handle projection customization due to an external
 * schema.
 */

public class WildcardTupleRequest extends ImpliedTupleRequest {

  public static final RequestedTuple ALL_MEMBERS =
      new WildcardTupleRequest();
