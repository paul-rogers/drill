...
class EvfV1ScanBuilder {
  ...
  /**
   * Builds the reader's row-set based scan operator.
   */
  ...
  protected static void initScanBuilder(EasyFormatPlugin<? extends FormatPluginConfig> plugin,
    ...
    builder.setFileSystemConfig(plugin.easyConfig().fsConf);
    ...
    builder.errorContext(
        currentBuilder -> currentBuilder
            .addContext("Format plugin", plugin.easyConfig().defaultName)
