...
public abstract class UnknownValueListener extends AbstractValueListener implements NullTypeMarker {
  ...
  public static class UnknownFieldListener extends UnknownValueListener {

    public UnknownFieldListener(JsonLoaderImpl loader, TupleWriter tupleWriter, String key) {
    ...
    private ValueListener resolveScalar(JsonType type) {
      return resolveTo(ScalarListener.listenerFor(loader, tupleWriter, key, type));
    }
    ...
    public void forceResolution() {
      logger.warn("Ambiguous type! JSON field {}" +
          ...
          key);
      resolveTo(ScalarListener.listenerFor(loader, tupleWriter, key, JsonType.STRING));
    }
  }
}
