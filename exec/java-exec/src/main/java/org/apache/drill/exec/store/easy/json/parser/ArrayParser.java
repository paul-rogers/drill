...
/**
 * Parses <code>[ ((value | null)(, (value | null))* )? ]</code><br>
 */
abstract class ArrayParser extends ContainerParser {

  /**
   * Parses <code>[ value, value ... ]</code><br>
  ...
  protected static class ScalarArrayParser extends ArrayParser {
    ...
    public ScalarArrayParser(JsonElementParser parent, String fieldName,
      ...
      super(parent, fieldName, writer, null);
  ...
  /**
   * Parses <code>[ ((item | null)(, (item | null)* )? ]</code>
   */
  protected static class ObjectArrayParser extends ArrayParser {
    ...
    public ObjectArrayParser(JsonElementParser parent, String fieldName,
        ArrayWriter writer, ObjectParser objectParser, TupleProjection projection) {
      super(parent, fieldName, writer, projection);
  ...
  public ArrayParser(JsonElementParser parent, String fieldName,
      ArrayWriter writer, TupleProjection projection) {
