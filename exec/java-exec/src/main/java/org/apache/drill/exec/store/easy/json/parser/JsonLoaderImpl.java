 ...
 * projected for {@code SEELCT COUNT(*)} queries.</li>
...
public class JsonLoaderImpl implements JsonLoader {
    ...
    switch (token) {
      ...
      case START_ARRAY:
        if (options.skipOuterList) {
          return new RootArrayParser(this, rootWriter, rootProjection());
        } else {
          throw UserException
            .dataReadError()
      ...
      case START_OBJECT:
        ...
        return new RootTupleState(this, rootWriter, rootProjection());
  ...
  private TupleProjection rootProjection() {
    return options.rootProjection == null ? TupleProjectionImpl.projectAll() : options.rootProjection;
  }
  ...
  public UserException syntaxError(JsonToken token, String context, String expected) {
  ...
  public UserException syntaxError(JsonToken token) {
    return UserException
        .dataReadError()
  ...
  public UserException syntaxError(String message) {
    return UserException
        .dataReadError()
        .message(message)
        .addContext("Location", tokenizer.context())
  ...
  public UserException ioException(IOException e) {
    return UserException
        .dataReadError(e)
  ...
  public UserException typeError(UnsupportedConversionError e) {
    return UserException
        .dataReadError()
  ...
  public UserException typeError(UnsupportedConversionError e, String msg) {
    return UserException
        .dataReadError()
        .message(msg)
