...
public abstract class BaseFieldOutput extends TextOutput {
  ...
  protected final ResultSetLoader resultLoader;
  protected final TupleLoader writer;
  ...
  public void finishRecord() {
    ...
    resultLoader.saveRow();
  }

  @Override
  public long getRecordCount() {
    return resultLoader.rowCount();
  }

  @Override
  public boolean isFull() {
    return resultLoader.isFull();
  }
}
