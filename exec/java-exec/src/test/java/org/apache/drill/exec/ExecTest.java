...
public class ExecTest extends DrillTest {
  ...
  /**
   * Set up a mock Drillbit context. Not all methods in the mock need
   * be called, and each method can be called any number of times.
   * To do this, we must tell JMockit that the minimum number of times
