...
//    DrillConfig config = DrillConfig.create();
    long maxAlloc = 100 * ONE_MEG;
    BufferAllocator allocator = RootAllocatorFactory.newRoot(maxAlloc);
    ...
    OperatorCodeGenerator opCodeGen = new OperatorCodeGenerator(context, popConfig);
    VectorAccessible batch = null;
    SingleBatchSorter sorter = opCodeGen.getSorter(batch);
  }
