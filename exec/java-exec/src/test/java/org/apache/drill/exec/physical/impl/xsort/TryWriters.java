...
public class TryWriters {

  public OperatorFixture fixture;
  private VectorContainerWriter writer;
  private OperatorExecContext oContext;
  private ListWriter list;

  public static void main(String[] args) {
    try {
      TryWriters inst = new TryWriters();
      inst.run();
      inst.close();
    } catch (Exception e) {
  ...
  private void run() throws Exception {
    ...
    RowSet expected = fixture.rowSetBuilder(schema)
        .add(10, "Fred", new int[] { 100, 110, 120 } )
        .add(20, "Wilma", null)
        .build();
