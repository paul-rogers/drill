...
public class FieldBuilder {
  ...
  public FieldBuilder(String name, MinorType type) {
    this.name = name;
  ...
  public FieldBuilder setPrecision(int precision) {
  ...
  public FieldBuilder setPrecisionAndScale(int precision, int scale) {
    if (precision != 0) {
      typeBuilder.setPrecision(precision);
