...
//  @JsonInclude(Include.NON_NULL)
  ...
  private PlanProperties(@JsonProperty("version") int version,
                         ...
                         @JsonProperty("hasRMPlan") boolean hasRMPlan
                         ) {
  ...
  public static class PlanPropertiesBuilder {
    ...
    private boolean hasRMPlan = false;
    ...
    public PlanPropertiesBuilder generator(boolean hasRMPLan) {
      this.hasRMPlan = hasRMPlan;
      return this;
    }

    public PlanProperties build() {
      return new PlanProperties(version, generator, type, mode, options, queueNumber, hasRMPlan);
    }
